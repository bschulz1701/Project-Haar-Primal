...
void setup() {
	...
	Serial.println("BaroVue10");
	Serial.println("Time[s]\tPres[mBar]\tTemp[°C]\tPres1[mBar]\tTemp1A[°C]\tTemp1B[°C]\tRH1[%]\tPres2[mBar]\tTemp2A[°C]\tTemp2B[°C]\tRH2[%]");
...
void loop() {
	...
	data = data.substring(4, data.length()); //Trim address val
